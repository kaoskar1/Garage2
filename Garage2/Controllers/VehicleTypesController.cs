...
namespace Garage2.Controllers
{
    public class VehicleTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Description")] VehicleType vehicleType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Description")] VehicleType vehicleType)
        {
            if (ModelState.IsValid)
            {
