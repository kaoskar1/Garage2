...
namespace Garage2.Controllers
{
    public class ParkedVehicles2Controller : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,VehicleType,Brand,Model,Color,RegNo,NoWheels,CheckInTime")] ParkedVehicle parkedVehicle)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,VehicleType,Brand,Model,Color,RegNo,NoWheels,CheckInTime")] ParkedVehicle parkedVehicle)
        {
            if (ModelState.IsValid)
            {
